...
/**
 * A class that allows building an instance of [LlamaCloudAdminClient] with [OkHttpClient] as the
...
class LlamaCloudAdminOkHttpClient private constructor() {
    ...
    companion object {
         ...
         */
        @JvmStatic fun fromEnv(): LlamaCloudAdminClient = builder().fromEnv().build()
    }
