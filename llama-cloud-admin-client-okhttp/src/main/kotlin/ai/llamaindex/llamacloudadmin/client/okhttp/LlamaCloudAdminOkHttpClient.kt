...
package ai.llamaindex.llamacloudadmin.client.okhttp
...
import ai.llamaindex.llamacloudadmin.client.okhttp.OkHttpClient
...
/**
 * A class that allows building an instance of [LlamaCloudAdminClient] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class LlamaCloudAdminOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [LlamaCloudAdminClient]. */
        @JvmStatic
        fun builder() = Builder()
         ...
         */
        @JvmStatic
        fun fromEnv(): LlamaCloudAdminClient = builder().fromEnv().build()
    }

    /** A builder for [LlamaCloudAdminOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [LlamaCloudAdminClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LlamaCloudAdminClient =
            LlamaCloudAdminClientImpl(clientOptions
