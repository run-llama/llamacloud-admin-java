...
/**
 * A class that allows building an instance of [LlamaCloudAdminClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class LlamaCloudAdminOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [LlamaCloudAdminClientAsync]. */
        @JvmStatic
        fun builder() = Builder()
         ...
         */
        @JvmStatic
        fun fromEnv(): LlamaCloudAdminClientAsync = builder().fromEnv().build()
    }

    /** A builder for [LlamaCloudAdminOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [LlamaCloudAdminClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LlamaCloudAdminClientAsync =
