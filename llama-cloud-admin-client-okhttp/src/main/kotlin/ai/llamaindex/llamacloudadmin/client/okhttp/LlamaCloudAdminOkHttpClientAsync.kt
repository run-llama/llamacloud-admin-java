...
class LlamaCloudAdminOkHttpClientAsync private constructor() {
    ...
    companion object {
         ...
         */
        @JvmStatic fun fromEnv(): LlamaCloudAdminClientAsync = builder().fromEnv().build()
    }
    ...
    class Builder internal constructor() {
         ...
         *
         * Defaults to [ai.llamaindex.llamacloudadmin.core.jsonMapper]. The default is usually
        ...
        fun build(): LlamaCloudAdminClientAsync =
            LlamaCloudAdminClientAsyncImpl(
                clientOptions
                    .httpClient(
