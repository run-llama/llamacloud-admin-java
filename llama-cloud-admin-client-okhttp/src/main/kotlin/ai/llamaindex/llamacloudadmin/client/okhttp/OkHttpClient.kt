...
import ai.llamaindex.llamacloudadmin.core.http.HttpRequestBody
...
internal constructor(
    ...
    override fun execute(
        ...
        return try {
            ...
            throw LlamaCloudAdminIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(LlamaCloudAdminIoException("Request failed", e))
                }
            }
        )
