...
dependencies {
    testImplementation(project(":llama-cloud-admin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../llama-cloud-admin-core/src/main/resources/META-INF/proguard/llama-cloud-admin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("ai.llamaindex.llamacloudadmin.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../llama-cloud-admin-core/src/main/resources/META-INF/proguard/llama-cloud-admin-core.pro",
