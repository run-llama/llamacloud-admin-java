...
internal class OrganizationMemberTest {
    ...
    fun create() {
        ...
        assertThat(organizationMember.organizationId())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(organizationMember.roles())
            .containsExactly(
                UserOrganizationRole.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .organizationId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(organizationMember.createdAt())
        ...
        assertThat(organizationMember.updatedAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedOrganizationMember =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(organizationMember),
                jacksonTypeRef<OrganizationMember>(),
            )
