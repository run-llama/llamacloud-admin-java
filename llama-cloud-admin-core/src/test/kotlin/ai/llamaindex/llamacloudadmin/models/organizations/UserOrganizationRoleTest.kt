...
internal class UserOrganizationRoleTest {
    ...
    fun create() {
        ...
        assertThat(userOrganizationRole.organizationId())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(userOrganizationRole.role())
            .isEqualTo(
                Role.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .name("x")
        ...
        assertThat(userOrganizationRole.createdAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(userOrganizationRole.projectIds().getOrNull())
            .containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(userOrganizationRole.updatedAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedUserOrganizationRole =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(userOrganizationRole),
                jacksonTypeRef<UserOrganizationRole>(),
            )
