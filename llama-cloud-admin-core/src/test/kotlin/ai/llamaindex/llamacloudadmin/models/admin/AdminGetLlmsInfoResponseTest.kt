...
internal class AdminGetLlmsInfoResponseTest {
    ...
    @Test
    fun create() {
        val adminGetLlmsInfoResponse =
            AdminGetLlmsInfoResponse.builder()
                .llmInfo(
                    AdminGetLlmsInfoResponse.LlmInfo.builder()
        ...
        assertThat(adminGetLlmsInfoResponse.llmInfo())
            .isEqualTo(
                AdminGetLlmsInfoResponse.LlmInfo.builder()
                    .putAdditionalProperty(
                        "foo",
    ...
    fun roundtrip() {
        ...
        val roundtrippedAdminGetLlmsInfoResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(adminGetLlmsInfoResponse),
                jacksonTypeRef<AdminGetLlmsInfoResponse>(),
            )
