...
internal class InviteListMinePageResponseTest {
    ...
    @Test
    fun create() {
      val inviteListMinePageResponse = InviteListMinePageResponse.builder()
          .addItem(Invite.builder()
              .id("id")
      ...
      assertThat(inviteListMinePageResponse.items()).containsExactly(Invite.builder()
          .id("id")
          .organizationId("organization_id")
          .organizationName("organization_name")
          .role("role")
    ...
    fun roundtrip() {
      ...
      val roundtrippedInviteListMinePageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(inviteListMinePageResponse), jacksonTypeRef<InviteListMinePageResponse>())
