...
internal class UserListProjectsResponseTest {
    ...
    @Test
    fun create() {
      val userListProjectsResponse = UserListProjectsResponse.builder()
      ...
      assertThat(userListProjectsResponse.organizationId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(userListProjectsResponse.createdAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(userListProjectsResponse.isDefault()).contains(true)
      assertThat(userListProjectsResponse.updatedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedUserListProjectsResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(userListProjectsResponse), jacksonTypeRef<UserListProjectsResponse>())
