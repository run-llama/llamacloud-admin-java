...
internal class AdminGetOcrStatusResponseTest {
    ...
    @Test
    fun create() {
        val adminGetOcrStatusResponse =
            AdminGetOcrStatusResponse.builder()
        ...
        assertThat(adminGetOcrStatusResponse.status())
            .isEqualTo(AdminGetOcrStatusResponse.Status.DEGRADED)
    ...
    fun roundtrip() {
        ...
        val roundtrippedAdminGetOcrStatusResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(adminGetOcrStatusResponse),
                jacksonTypeRef<AdminGetOcrStatusResponse>(),
            )
