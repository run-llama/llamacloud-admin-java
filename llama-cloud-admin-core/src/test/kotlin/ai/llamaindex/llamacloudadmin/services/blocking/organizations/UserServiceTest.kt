...
internal class UserServiceTest {
    ...
    fun add() {
      ...
      val organizationMembers = userService.add(UserAddParams.builder()
          .organizationId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun addToProject() {
      ...
      val response = userService.addToProject(UserAddToProjectParams.builder()
          .organizationId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .userId("user_id")
    ...
    fun assignRole() {
      ...
      val userOrganizationRole = userService.assignRole(UserAssignRoleParams.builder()
    ...
    fun listMembers() {
      ...
      val organizationMembers = userService.listMembers("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun listProjects() {
      ...
      val response = userService.listProjects(UserListProjectsParams.builder()
          .organizationId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .userId("user_id")
          .build())
    ...
    fun removeFromProject() {
      ...
      val response = userService.removeFromProject(UserRemoveFromProjectParams.builder()
          .organizationId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .userId("user_id")
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
