...
internal class UserServiceAsyncTest {
    ...
    fun delete() {
      ...
      val future = userServiceAsync.delete(UserDeleteParams.builder()
    ...
    fun add() {
      ...
      val organizationMembersFuture = userServiceAsync.add(UserAddParams.builder()
          .organizationId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addBody(UserAddParams.Body.builder()
    ...
    fun addToProject() {
      ...
      val responseFuture = userServiceAsync.addToProject(UserAddToProjectParams.builder()
          .organizationId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .userId("user_id")
    ...
    fun assignRole() {
      ...
      val userOrganizationRoleFuture = userServiceAsync.assignRole(UserAssignRoleParams.builder()
    ...
    fun listMembers() {
      ...
      val organizationMembersFuture = userServiceAsync.listMembers("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun listProjects() {
      ...
      val responseFuture = userServiceAsync.listProjects(UserListProjectsParams.builder()
          .organizationId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .userId("user_id")
          .build())
    ...
    fun removeFromProject() {
      ...
      val responseFuture = userServiceAsync.removeFromProject(UserRemoveFromProjectParams.builder()
          .organizationId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .userId("user_id")
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
