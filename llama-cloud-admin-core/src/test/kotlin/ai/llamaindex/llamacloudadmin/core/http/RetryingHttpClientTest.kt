    ...
    fun execute_withRetryableException(async: Boolean) {
        ...
        val failingHttpClient = object : HttpClient {
            override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
                callCount++
                if (callCount == 1) {
                    throw LlamaCloudAdminRetryableException("Simulated retryable failure")
                }
            ...
            override fun executeAsync(request: HttpRequest, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
                ...
                if (callCount == 1) {
                    ...
                    future.completeExceptionally(LlamaCloudAdminRetryableException("Simulated retryable failure"))
                    return future
                }
