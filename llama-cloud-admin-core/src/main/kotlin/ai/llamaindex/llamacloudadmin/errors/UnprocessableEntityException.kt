...
class UnprocessableEntityException private constructor(
    private val headers: Headers,
    private val body: JsonValue,
    cause: Throwable?,

) : LlamaCloudAdminServiceException(
  "422: ${if (body.isMissing()) "Unknown" else jsonMapper().writeValueAsString(body)}", cause
) {
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(unprocessableEntityException: UnprocessableEntityException) =
            apply {
