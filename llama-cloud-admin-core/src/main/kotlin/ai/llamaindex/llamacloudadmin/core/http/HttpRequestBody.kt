...
interface HttpRequestBody : AutoCloseable {
     ...
     *
     * The most typical case when a request can't be retried is if the request body is being streamed. In this case the
     * body data isn't available on subsequent attempts.
     */
