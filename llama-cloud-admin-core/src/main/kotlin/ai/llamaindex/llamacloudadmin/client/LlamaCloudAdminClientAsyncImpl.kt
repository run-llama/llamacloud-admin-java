...
class LlamaCloudAdminClientAsyncImpl(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: LlamaCloudAdminClientAsync.WithRawResponse by lazy {
    ...
    private val invites: InviteServiceAsync by lazy {
    ...
    override fun withOptions(
        ...
        LlamaCloudAdminClientAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            LlamaCloudAdminClientAsyncImpl.WithRawResponseImpl(
