...
/**
 * A client for interacting with the Llama Cloud Admin REST API synchronously.
...
interface LlamaCloudAdminClient {
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): LlamaCloudAdminClient.WithRawResponse
