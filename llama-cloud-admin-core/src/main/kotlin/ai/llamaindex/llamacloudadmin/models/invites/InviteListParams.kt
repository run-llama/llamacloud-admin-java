...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inviteListParams: InviteListParams) = apply {
            pageSize = inviteListParams.pageSize
            pageToken = inviteListParams.pageToken
    ...
    override fun toString() =
        "InviteListParams{pageSize=$pageSize, pageToken=$pageToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
