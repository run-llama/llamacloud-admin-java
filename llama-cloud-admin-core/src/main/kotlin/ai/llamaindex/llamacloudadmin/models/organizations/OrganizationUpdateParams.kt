...
class OrganizationUpdateParams private constructor(
    ...
    /** API request schema for updating an organization. */
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is OrganizationUpdateParams && organizationId == other.organizationId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }
