...
class ProjectDeleteParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(projectDeleteParams: ProjectDeleteParams) =
            apply {
                projectId = projectDeleteParams.projectId
                organizationId = projectDeleteParams.organizationId
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProjectDeleteParams && projectId == other.projectId && organizationId == other.organizationId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties
    }

    override fun hashCode(): Int = Objects.hash(projectId, organizationId, additionalHeaders, additionalQueryParams, additionalBodyProperties)

    override fun toString() = "ProjectDeleteParams{projectId=$projectId, organizationId=$organizationId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
