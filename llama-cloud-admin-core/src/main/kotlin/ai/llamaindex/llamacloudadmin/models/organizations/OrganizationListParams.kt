...
class OrganizationListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationListParams: OrganizationListParams) =
            apply {
                name = organizationListParams.name
                pageSize = organizationListParams.pageSize
                pageToken = organizationListParams.pageToken
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is OrganizationListParams && name == other.name && pageSize == other.pageSize && pageToken == other.pageToken && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(name, pageSize, pageToken, additionalHeaders, additionalQueryParams)

    override fun toString() = "OrganizationListParams{name=$name, pageSize=$pageSize, pageToken=$pageToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
