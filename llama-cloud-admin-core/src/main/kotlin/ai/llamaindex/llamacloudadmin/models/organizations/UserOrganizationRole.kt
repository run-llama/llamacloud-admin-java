...
private constructor(
    ...
    ) : this(id, organizationId, role, userId, createdAt, projectIds, updatedAt, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userOrganizationRole: UserOrganizationRole) = apply {
     ...
     *   its expected type.
     */
    fun validate(): UserOrganizationRole = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserOrganizationRole &&
            id == other.id &&
    ...
    override fun toString() =
        "UserOrganizationRole{id=$id, organizationId=$organizationId, role=$role, userId=$userId, createdAt=$createdAt, projectIds=$projectIds, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
