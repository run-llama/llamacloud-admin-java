 ...
 * Delete an API key.
 *
 * If the API key belongs to a project, validates user has admin permissions for that project. If
 * the API key has no project, validates it belongs to the current user.
 *
