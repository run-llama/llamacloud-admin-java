...
class OrganizationListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    private val items: JsonField<List<Organization>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("items") @ExcludeMissing items: JsonField<List<Organization>> = JsonMissing.of(),
     ...
     */
    fun items(): List<Organization> = items.getRequired("items")
    ...
    @JsonProperty("items")
    @ExcludeMissing
    fun _items(): JsonField<List<Organization>> = items
    ...
    class Builder internal constructor() {
        ...
        private var items: JsonField<MutableList<Organization>>? = null
        ...
        @JvmSynthetic
        internal fun from(organizationListPageResponse: OrganizationListPageResponse) =
            apply {
                items = organizationListPageResponse.items.map { it.toMutableList() }
                nextPageToken = organizationListPageResponse.nextPageToken
                totalSize = organizationListPageResponse.totalSize
                additionalProperties = organizationListPageResponse.additionalProperties.toMutableMap()
            }

        /** The list of items. */
        fun items(items: List<Organization>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<Organization>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<Organization>>) =
            apply {
                this.items = items.map { it.toMutableList() }
            }

        /**
         * Adds a single [Organization] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: Organization) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): OrganizationListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is OrganizationListPageResponse && items == other.items && nextPageToken == other.nextPageToken && totalSize == other.totalSize && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "OrganizationListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
