...
private constructor(
    ...
    private constructor(
        @JsonProperty("items")
        @ExcludeMissing
        items: JsonField<List<Organization>> = JsonMissing.of(),
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<Organization>> = items
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<Organization>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun items(items: JsonField<List<Organization>>) = apply {
         ...
         */
        fun addItem(item: Organization) = apply {
            items =
    ...
    override fun toString() =
        "OrganizationListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
