...
class UserListMembersParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): UserListMembersParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userListMembersParams: UserListMembersParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is UserListMembersParams && organizationId == other.organizationId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(organizationId, additionalHeaders, additionalQueryParams)

    override fun toString() = "UserListMembersParams{organizationId=$organizationId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
