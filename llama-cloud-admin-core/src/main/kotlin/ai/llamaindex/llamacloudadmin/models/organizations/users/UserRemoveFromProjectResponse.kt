...
class UserRemoveFromProjectResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [UserRemoveFromProjectResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userRemoveFromProjectResponse: UserRemoveFromProjectResponse) =
            apply {
         ...
         */
        fun build(): UserRemoveFromProjectResponse = UserRemoveFromProjectResponse(additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): UserRemoveFromProjectResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is UserRemoveFromProjectResponse && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "UserRemoveFromProjectResponse{additionalProperties=$additionalProperties}"
}
