...
class UserAssignRoleParams private constructor(
     ...
     *
     * Unlike [bodyOrganizationId], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userAssignRoleParams: UserAssignRoleParams) =
            apply {
        ...
        fun pathOrganizationId(pathOrganizationId: String?) =
            apply {
        ...
        fun pathOrganizationId(pathOrganizationId: Optional<String>) = pathOrganizationId(pathOrganizationId.getOrNull())
         ...
         *
         * You should usually call [Builder.bodyOrganizationId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun bodyOrganizationId(bodyOrganizationId: JsonField<String>) =
            apply {
                body.bodyOrganizationId(bodyOrganizationId)
            }

        /** The role's ID. */
        fun roleId(roleId: String) =
            apply {
                body.roleId(roleId)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("organization_id") @ExcludeMissing bodyOrganizationId: JsonField<String> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            /** The organization's ID. */
            fun bodyOrganizationId(bodyOrganizationId: String) = bodyOrganizationId(JsonField.of(bodyOrganizationId))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (bodyOrganizationId.asKnown().isPresent) 1 else 0) + (if (roleId.asKnown().isPresent) 1 else 0) + (if (userId.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && bodyOrganizationId == other.bodyOrganizationId && roleId == other.roleId && userId == other.userId && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(bodyOrganizationId, roleId, userId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{bodyOrganizationId=$bodyOrganizationId, roleId=$roleId, userId=$userId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is UserAssignRoleParams && pathOrganizationId == other.pathOrganizationId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(pathOrganizationId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "UserAssignRoleParams{pathOrganizationId=$pathOrganizationId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
