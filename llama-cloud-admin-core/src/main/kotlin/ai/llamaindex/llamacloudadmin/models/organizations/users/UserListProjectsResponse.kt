...
class UserListProjectsResponse
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userListProjectsResponse: UserListProjectsResponse) = apply {
     ...
     *   its expected type.
     */
    fun validate(): UserListProjectsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserListProjectsResponse &&
            id == other.id &&
            name == other.name &&
    ...
    override fun toString() =
        "UserListProjectsResponse{id=$id, name=$name, organizationId=$organizationId, createdAt=$createdAt, isDefault=$isDefault, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
