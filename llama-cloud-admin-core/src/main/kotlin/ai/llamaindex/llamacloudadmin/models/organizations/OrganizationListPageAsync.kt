...
class OrganizationListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<OrganizationListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<Organization> =
        AutoPagerAsync.from(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationListPageAsync: OrganizationListPageAsync) =
            apply {
        ...
        fun service(service: OrganizationServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is OrganizationListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "OrganizationListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
