...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ProjectGetUsageParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ProjectGetUsageParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ProjectGetUsageParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(projectGetUsageParams: ProjectGetUsageParams) = apply {
            projectId = projectGetUsageParams.projectId
            getCurrentInvoiceTotal = projectGetUsageParams.getCurrentInvoiceTotal
            organizationId = projectGetUsageParams.organizationId
            additionalHeaders = projectGetUsageParams.additionalHeaders.toBuilder()
            additionalQueryParams = projectGetUsageParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ProjectGetUsageParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ProjectGetUsageParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProjectGetUsageParams &&
    ...
    override fun toString() =
        "ProjectGetUsageParams{projectId=$projectId, getCurrentInvoiceTotal=$getCurrentInvoiceTotal, organizationId=$organizationId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
