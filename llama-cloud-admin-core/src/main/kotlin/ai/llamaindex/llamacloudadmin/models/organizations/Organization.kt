...
private constructor(
    ...
    ) : this(id, name, createdAt, metadata, updatedAt, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, name, createdAt, metadata, updatedAt, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "Organization{id=$id, name=$name, createdAt=$createdAt, metadata=$metadata, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
