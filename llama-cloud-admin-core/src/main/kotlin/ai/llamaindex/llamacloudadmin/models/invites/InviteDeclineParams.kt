...
class InviteDeclineParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): InviteDeclineParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inviteDeclineParams: InviteDeclineParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InviteDeclineParams && inviteId == other.inviteId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties
    }

    override fun hashCode(): Int = Objects.hash(inviteId, additionalHeaders, additionalQueryParams, additionalBodyProperties)

    override fun toString() = "InviteDeclineParams{inviteId=$inviteId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
