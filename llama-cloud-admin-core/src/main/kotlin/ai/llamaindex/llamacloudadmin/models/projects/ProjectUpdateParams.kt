...
class ProjectUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectUpdateParams: ProjectUpdateParams) =
            apply {
                ...
                organizationId = projectUpdateParams.organizationId
    ...
    /** API request schema for updating a project. */
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && name == other.name && additionalProperties == other.additionalProperties
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProjectUpdateParams && projectId == other.projectId && organizationId == other.organizationId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(projectId, organizationId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ProjectUpdateParams{projectId=$projectId, organizationId=$organizationId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
