...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("roles")
        @ExcludeMissing
        roles: JsonField<List<UserOrganizationRole>> = JsonMissing.of(),
        ...
        @ExcludeMissing
        invitedByUserEmail: JsonField<String> = JsonMissing.of(),
        @JsonProperty("invited_by_user_id")
        @ExcludeMissing
        invitedByUserId: JsonField<String> = JsonMissing.of(),
    ...
    fun invitedByUserEmail(): Optional<String> =
        invitedByUserEmail.getOptional("invited_by_user_email")
     ...
     *
     * Unlike [invitedByUserEmail], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @Deprecated("deprecated")
    @JsonProperty("invited_by_user_email")
     ...
     */
    @JsonProperty("pending") @ExcludeMissing fun _pending(): JsonField<Boolean> = pending
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationMember: OrganizationMember) = apply {
         ...
         *
         * You should usually call [Builder.roles] with a well-typed `List<UserOrganizationRole>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun roles(roles: JsonField<List<UserOrganizationRole>>) = apply {
         ...
         */
        fun addRole(role: UserOrganizationRole) = apply {
            roles =
        ...
        /** The email address of the user who added the user to the organization. */
        @Deprecated("deprecated")
        fun invitedByUserEmail(invitedByUserEmail: String?) =
            invitedByUserEmail(JsonField.ofNullable(invitedByUserEmail))

        /**
         * Alias for calling [Builder.invitedByUserEmail] with `invitedByUserEmail.orElse(null)`.
         */
        @Deprecated("deprecated")
        fun invitedByUserEmail(invitedByUserEmail: Optional<String>) =
            invitedByUserEmail(invitedByUserEmail.getOrNull())

        /**
         * Sets [Builder.invitedByUserEmail] to an arbitrary JSON value.
         *
         * You should usually call [Builder.invitedByUserEmail] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        @Deprecated("deprecated")
        fun invitedByUserEmail(invitedByUserEmail: JsonField<String>) = apply {
            this.invitedByUserEmail = invitedByUserEmail
        }

        /** The user ID of the user who added the user to the organization. */
        fun invitedByUserId(invitedByUserId: String?) =
            invitedByUserId(JsonField.ofNullable(invitedByUserId))

        /** Alias for calling [Builder.invitedByUserId] with `invitedByUserId.orElse(null)`. */
        fun invitedByUserId(invitedByUserId: Optional<String>) =
            invitedByUserId(invitedByUserId.getOrNull())

        /**
         * Sets [Builder.invitedByUserId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.invitedByUserId] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun invitedByUserId(invitedByUserId: JsonField<String>) = apply {
         ...
         *
         * You should usually call [Builder.pending] with a well-typed [Boolean] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun pending(pending: JsonField<Boolean>) = apply { this.pending = pending }
     ...
     *   its expected type.
     */
    fun validate(): OrganizationMember = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (invitedByUserEmail.asKnown().isPresent) 1 else 0) +
            (if (invitedByUserId.asKnown().isPresent) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrganizationMember &&
            ...
            email == other.email &&
            invitedByUserEmail == other.invitedByUserEmail &&
    ...
    override fun toString() =
        "OrganizationMember{id=$id, organizationId=$organizationId, roles=$roles, createdAt=$createdAt, email=$email, invitedByUserEmail=$invitedByUserEmail, invitedByUserId=$invitedByUserId, pending=$pending, updatedAt=$updatedAt, userId=$userId, additionalProperties=$additionalProperties}"
}
