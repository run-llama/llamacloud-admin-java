...
private constructor(
    ...
    override fun toString() =
        "ApiKey{id=$id, redactedApiKey=$redactedApiKey, userId=$userId, createdAt=$createdAt, expiresAt=$expiresAt, keyType=$keyType, metadata=$metadata, name=$name, projectId=$projectId, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
