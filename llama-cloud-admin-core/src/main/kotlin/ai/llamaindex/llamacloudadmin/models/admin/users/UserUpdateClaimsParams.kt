 ...
 * Global admin only.
 */
class UserUpdateClaimsParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): UserUpdateClaimsParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userUpdateClaimsParams: UserUpdateClaimsParams) =
            apply {
        ...
        fun removeClaims(removeClaims: Optional<List<RemoveClaim>>) = removeClaims(removeClaims.getOrNull())

        /**
         * Sets [Builder.removeClaims] to an arbitrary JSON value.
         *
         * You should usually call [Builder.removeClaims] with a well-typed `List<RemoveClaim>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun removeClaims(removeClaims: JsonField<List<RemoveClaim>>) =
            apply {
                body.removeClaims(removeClaims)
            }
         ...
         */
        fun addRemoveClaim(removeClaim: RemoveClaim) =
            apply {
                body.addRemoveClaim(removeClaim)
            }
         ...
         * change a single claim without resending the full claim set.
         */
        fun setClaims(setClaims: SetClaims?) =
            apply {
                body.setClaims(setClaims)
            }
         ...
         *
         * You should usually call [Builder.setClaims] with a well-typed [SetClaims] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun setClaims(setClaims: JsonField<SetClaims>) =
            apply {
                body.setClaims(setClaims)
            }
     ...
     *
     * Claims in `set_claims` are added or overwritten; claims named in
     * `remove_claims` are reset to their system default. Claims not referenced
     * by either field are left unchanged. At least one of the two fields must be
     * provided, and a claim may not appear in both.
     */
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("remove_claims") @ExcludeMissing removeClaims: JsonField<List<RemoveClaim>> = JsonMissing.of(),
            @JsonProperty("set_claims") @ExcludeMissing setClaims: JsonField<SetClaims> = JsonMissing.of()
        ) : this(
          removeClaims,
          setClaims,
          mutableMapOf(),
        ...
        class Builder internal constructor() {
            ...
            /** Names of claims to reset to their system default. */
            fun removeClaims(removeClaims: List<RemoveClaim>?) = removeClaims(JsonField.ofNullable(removeClaims))
            ...
            fun addRemoveClaim(removeClaim: RemoveClaim) =
                apply {
                    removeClaims = (removeClaims ?: JsonField.of(mutableListOf())).also {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (removeClaims.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (setClaims.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && removeClaims == other.removeClaims && setClaims == other.setClaims && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(removeClaims, setClaims, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{removeClaims=$removeClaims, setClaims=$setClaims, additionalProperties=$additionalProperties}"
    }

    class RemoveClaim @JsonCreator private constructor(
     ...
     * change a single claim without resending the full claim set.
     */
    class SetClaims @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(setClaims: SetClaims) =
                apply {
            ...
            /** Whether the user is allowed to delete organizations. */
            fun allowOrgDeletion(allowOrgDeletion: Boolean?) = allowOrgDeletion(JsonField.ofNullable(allowOrgDeletion))
             ...
             */
            fun allowOrgDeletion(allowOrgDeletion: Boolean) = allowOrgDeletion(allowOrgDeletion as Boolean?)

            /** Alias for calling [Builder.allowOrgDeletion] with `allowOrgDeletion.orElse(null)`. */
            fun allowOrgDeletion(allowOrgDeletion: Optional<Boolean>) = allowOrgDeletion(allowOrgDeletion.getOrNull())
            ...
            /** Whether the user is allowed to create organizations. */
            fun allowedOrgCreation(allowedOrgCreation: Boolean?) = allowedOrgCreation(JsonField.ofNullable(allowedOrgCreation))
             ...
             * This unboxed primitive overload exists for backwards compatibility.
             */
            fun allowedOrgCreation(allowedOrgCreation: Boolean) = allowedOrgCreation(allowedOrgCreation as Boolean?)

            /** Alias for calling [Builder.allowedOrgCreation] with `allowedOrgCreation.orElse(null)`. */
            fun allowedOrgCreation(allowedOrgCreation: Optional<Boolean>) = allowedOrgCreation(allowedOrgCreation.getOrNull())
            ...
            /** Whether the user is allowed to access API data sources. */
            fun apiDatasourceAccess(apiDatasourceAccess: Boolean?) = apiDatasourceAccess(JsonField.ofNullable(apiDatasourceAccess))
             ...
             * This unboxed primitive overload exists for backwards compatibility.
             */
            fun apiDatasourceAccess(apiDatasourceAccess: Boolean) = apiDatasourceAccess(apiDatasourceAccess as Boolean?)

            /** Alias for calling [Builder.apiDatasourceAccess] with `apiDatasourceAccess.orElse(null)`. */
            fun apiDatasourceAccess(apiDatasourceAccess: Optional<Boolean>) = apiDatasourceAccess(apiDatasourceAccess.getOrNull())
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is SetClaims && allowOrgDeletion == other.allowOrgDeletion && allowedOrgCreation == other.allowedOrgCreation && apiDatasourceAccess == other.apiDatasourceAccess && maximumOrgCreation == other.maximumOrgCreation && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "SetClaims{allowOrgDeletion=$allowOrgDeletion, allowedOrgCreation=$allowedOrgCreation, apiDatasourceAccess=$apiDatasourceAccess, maximumOrgCreation=$maximumOrgCreation, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is UserUpdateClaimsParams && userId == other.userId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(userId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "UserUpdateClaimsParams{userId=$userId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
