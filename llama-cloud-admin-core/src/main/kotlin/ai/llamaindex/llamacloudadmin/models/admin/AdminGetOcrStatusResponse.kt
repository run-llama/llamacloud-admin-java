...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        gpuAvailable: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("gpu_device_count")
        @ExcludeMissing
        gpuDeviceCount: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("gpu_device_name")
        @ExcludeMissing
        gpuDeviceName: JsonField<String> = JsonMissing.of(),
    ) : this(
        status,
        device,
        errorMessage,
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(adminGetOcrStatusResponse: AdminGetOcrStatusResponse) = apply {
         ...
         *
         * You should usually call [Builder.device] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
         ...
         *
         * You should usually call [Builder.gpuAvailable] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun gpuAvailable(gpuAvailable: JsonField<Boolean>) = apply {
            this.gpuAvailable = gpuAvailable
        }

        fun gpuDeviceCount(gpuDeviceCount: Long?) =
            gpuDeviceCount(JsonField.ofNullable(gpuDeviceCount))
        ...
        fun gpuDeviceCount(gpuDeviceCount: Optional<Long>) =
            gpuDeviceCount(gpuDeviceCount.getOrNull())

        /**
         * Sets [Builder.gpuDeviceCount] to an arbitrary JSON value.
         *
         * You should usually call [Builder.gpuDeviceCount] with a well-typed [Long] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun gpuDeviceCount(gpuDeviceCount: JsonField<Long>) = apply {
            this.gpuDeviceCount = gpuDeviceCount
        }

        fun gpuDeviceName(gpuDeviceName: String?) =
            gpuDeviceName(JsonField.ofNullable(gpuDeviceName))

        /** Alias for calling [Builder.gpuDeviceName] with `gpuDeviceName.orElse(null)`. */
        fun gpuDeviceName(gpuDeviceName: Optional<String>) =
            gpuDeviceName(gpuDeviceName.getOrNull())

        /**
         * Sets [Builder.gpuDeviceName] to an arbitrary JSON value.
         *
         * You should usually call [Builder.gpuDeviceName] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun gpuDeviceName(gpuDeviceName: JsonField<String>) = apply {
     ...
     *   its expected type.
     */
    fun validate(): AdminGetOcrStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (status.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            (if (gpuAvailable.asKnown().isPresent) 1 else 0) +
            (if (gpuDeviceCount.asKnown().isPresent) 1 else 0) +
            (if (gpuDeviceName.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AdminGetOcrStatusResponse &&
            status == other.status &&
            device == other.device &&
            errorMessage == other.errorMessage &&
            gpuAvailable == other.gpuAvailable &&
            gpuDeviceCount == other.gpuDeviceCount &&
    ...
    override fun toString() =
        "AdminGetOcrStatusResponse{status=$status, device=$device, errorMessage=$errorMessage, gpuAvailable=$gpuAvailable, gpuDeviceCount=$gpuDeviceCount, gpuDeviceName=$gpuDeviceName, additionalProperties=$additionalProperties}"
}
