...
class OrganizationGetUsageParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OrganizationGetUsageParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationGetUsageParams: OrganizationGetUsageParams) =
            apply {
         ...
         */
        fun getCurrentInvoiceTotal(getCurrentInvoiceTotal: Boolean) = getCurrentInvoiceTotal(getCurrentInvoiceTotal as Boolean?)

        /** Alias for calling [Builder.getCurrentInvoiceTotal] with `getCurrentInvoiceTotal.orElse(null)`. */
        fun getCurrentInvoiceTotal(getCurrentInvoiceTotal: Optional<Boolean>) = getCurrentInvoiceTotal(getCurrentInvoiceTotal.getOrNull())
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is OrganizationGetUsageParams && organizationId == other.organizationId && getCurrentInvoiceTotal == other.getCurrentInvoiceTotal && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(organizationId, getCurrentInvoiceTotal, additionalHeaders, additionalQueryParams)

    override fun toString() = "OrganizationGetUsageParams{organizationId=$organizationId, getCurrentInvoiceTotal=$getCurrentInvoiceTotal, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
