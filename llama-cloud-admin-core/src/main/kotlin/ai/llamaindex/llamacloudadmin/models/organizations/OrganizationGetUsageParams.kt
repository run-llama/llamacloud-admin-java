...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(organizationGetUsageParams: OrganizationGetUsageParams) = apply {
            ...
            include = organizationGetUsageParams.include?.toMutableList()
    ...
    class Include @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        fun known(): Known =
            when (this) {
                OFFERS -> Known.OFFERS
                else -> throw LlamaCloudAdminInvalidDataException("Unknown Include: $value")
            }
    ...
    override fun toString() =
        "OrganizationGetUsageParams{organizationId=$organizationId, getCurrentInvoiceTotal=$getCurrentInvoiceTotal, include=$include, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
