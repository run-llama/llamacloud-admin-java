...
private constructor(
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<Invite>> = items
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.items] with a well-typed `List<Invite>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun items(items: JsonField<List<Invite>>) = apply {
