...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun memberUserId(memberUserId: String?) = apply { this.memberUserId = memberUserId }
    ...
    override fun hashCode(): Int =
        Objects.hash(organizationId, memberUserId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "UserDeleteParams{organizationId=$organizationId, memberUserId=$memberUserId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
