...
class ProjectCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(projectCreateParams: ProjectCreateParams) =
            apply {
                organizationId = projectCreateParams.organizationId
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProjectCreateParams && organizationId == other.organizationId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(organizationId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ProjectCreateParams{organizationId=$organizationId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
