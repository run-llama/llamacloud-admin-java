...
class InviteListMineParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): InviteListMineParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inviteListMineParams: InviteListMineParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InviteListMineParams && pageSize == other.pageSize && pageToken == other.pageToken && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(pageSize, pageToken, additionalHeaders, additionalQueryParams)

    override fun toString() = "InviteListMineParams{pageSize=$pageSize, pageToken=$pageToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
