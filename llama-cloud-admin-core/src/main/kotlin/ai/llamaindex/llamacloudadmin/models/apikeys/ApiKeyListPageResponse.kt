...
private constructor(
    private val items: JsonField<List<ApiKey>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("items") @ExcludeMissing items: JsonField<List<ApiKey>> = JsonMissing.of(),
     ...
     */
    fun items(): List<ApiKey> = items.getRequired("items")
     ...
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonField<List<ApiKey>> = items
    ...
    /** A builder for [ApiKeyListPageResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<ApiKey>>? = null
        ...
        @JvmSynthetic
        internal fun from(apiKeyListPageResponse: ApiKeyListPageResponse) = apply {
            items = apiKeyListPageResponse.items.map { it.toMutableList() }
            nextPageToken = apiKeyListPageResponse.nextPageToken
            totalSize = apiKeyListPageResponse.totalSize
            additionalProperties = apiKeyListPageResponse.additionalProperties.toMutableMap()
        }

        /** The list of items. */
        fun items(items: List<ApiKey>) = items(JsonField.of(items))

        /**
         * Sets [Builder.items] to an arbitrary JSON value.
         *
         * You should usually call [Builder.items] with a well-typed `List<ApiKey>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun items(items: JsonField<List<ApiKey>>) = apply {
            this.items = items.map { it.toMutableList() }
        }

        /**
         * Adds a single [ApiKey] to [items].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addItem(item: ApiKey) = apply {
            items =
    ...
    override fun toString() =
        "ApiKeyListPageResponse{items=$items, nextPageToken=$nextPageToken, totalSize=$totalSize, additionalProperties=$additionalProperties}"
}
