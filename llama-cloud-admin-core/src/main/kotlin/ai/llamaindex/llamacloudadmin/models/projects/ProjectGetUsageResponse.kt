...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProjectGetUsageResponse].
         *
    ...
    /** A builder for [ProjectGetUsageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(projectGetUsageResponse: ProjectGetUsageResponse) = apply {
            plan = projectGetUsageResponse.plan
            usage = projectGetUsageResponse.usage
            additionalProperties = projectGetUsageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProjectGetUsageResponse].
         *
         ...
         */
        fun build(): ProjectGetUsageResponse =
     ...
     *   its expected type.
     */
    fun validate(): ProjectGetUsageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProjectGetUsageResponse &&
            plan == other.plan &&
            usage == other.usage &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ProjectGetUsageResponse{plan=$plan, usage=$usage, additionalProperties=$additionalProperties}"
}
