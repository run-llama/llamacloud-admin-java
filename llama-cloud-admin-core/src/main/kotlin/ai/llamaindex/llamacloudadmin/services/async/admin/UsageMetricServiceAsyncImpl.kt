...
class UsageMetricServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    UsageMetricServiceAsync {

    private val withRawResponse: UsageMetricServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): UsageMetricServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): UsageMetricServiceAsync =
        UsageMetricServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            UsageMetricServiceAsyncImpl.WithRawResponseImpl(
