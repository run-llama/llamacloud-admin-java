...
interface InviteService {
    ...
    fun decline(inviteId: String) = decline(inviteId, InviteDeclineParams.none())
    ...
    fun decline(inviteId: String, params: InviteDeclineParams = InviteDeclineParams.none()) =
        decline(inviteId, params, RequestOptions.none())

    /** @see decline */
    fun decline(params: InviteDeclineParams, requestOptions: RequestOptions = RequestOptions.none())

    /** @see decline */
    fun decline(params: InviteDeclineParams) = decline(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * the same as [InviteService.decline].
         */
        @MustBeClosed
        fun decline(inviteId: String): HttpResponse = decline(inviteId, InviteDeclineParams.none())
        ...
        fun decline(
            ...
            params: InviteDeclineParams = InviteDeclineParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponse = decline(params.toBuilder().inviteId(inviteId).build(), requestOptions)
        ...
        fun decline(
            inviteId: String,
            params: InviteDeclineParams = InviteDeclineParams.none(),
        ): HttpResponse = decline(inviteId, params, RequestOptions.none())
        ...
        fun listMine(
            params: InviteListMineParams = InviteListMineParams.none()
        ): HttpResponseFor<InviteListMinePage> = listMine(params, RequestOptions.none())
