...
class UserServiceImpl internal constructor(
    ...
    override fun getClaims(params: UserGetClaimsParams, requestOptions: RequestOptions): UserClaims =
        // get /api/v1/admin/users/{user_id}/claims
        withRawResponse().getClaims(params, requestOptions).parse()

    override fun updateClaims(params: UserUpdateClaimsParams, requestOptions: RequestOptions): UserClaims =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun getClaims(params: UserGetClaimsParams, requestOptions: RequestOptions): HttpResponseFor<UserClaims> {
        ...
        override fun updateClaims(params: UserUpdateClaimsParams, requestOptions: RequestOptions): HttpResponseFor<UserClaims> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("userId", params.userId().getOrNull())
          val request = HttpRequest.builder()
