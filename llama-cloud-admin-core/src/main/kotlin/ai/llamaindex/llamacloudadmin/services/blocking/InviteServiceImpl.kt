...
class InviteServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : InviteService {

    private val withRawResponse: InviteService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): InviteService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): InviteService = InviteServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun accept(params: InviteAcceptParams, requestOptions: RequestOptions): InviteAcceptResponse =
    ...
    override fun listMine(params: InviteListMineParams, requestOptions: RequestOptions): InviteListMinePage =
        // get /api/v2/invites
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): InviteService.WithRawResponse = InviteServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val acceptHandler: Handler<InviteAcceptResponse> = jsonHandler<InviteAcceptResponse>(clientOptions.jsonMapper)

        override fun accept(params: InviteAcceptParams, requestOptions: RequestOptions): HttpResponseFor<InviteAcceptResponse> {
        ...
        override fun decline(params: InviteDeclineParams, requestOptions: RequestOptions): HttpResponse {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("inviteId", params.inviteId().getOrNull())
          val request = HttpRequest.builder()
        ...
        override fun listMine(params: InviteListMineParams, requestOptions: RequestOptions): HttpResponseFor<InviteListMinePage> {
          val request = HttpRequest.builder()
