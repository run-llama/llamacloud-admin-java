...
interface RoleService {
    ...
    fun list(organizationId: String): List<Role> = list(organizationId, RoleListParams.none())
    ...
    ): List<Role> = list(params.toBuilder().organizationId(organizationId).build(), requestOptions)
    ...
    /** @see list */
    fun list(params: RoleListParams): List<Role> = list(params, RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        fun list(
            organizationId: String,
            params: RoleListParams = RoleListParams.none(),
        ): HttpResponseFor<List<Role>> = list(organizationId, params, RequestOptions.none())
        ...
        ): HttpResponseFor<List<Role>> = list(organizationId, RoleListParams.none(), requestOptions)
    }
}
