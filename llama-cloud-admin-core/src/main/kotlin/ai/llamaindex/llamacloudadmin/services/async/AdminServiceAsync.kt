...
interface AdminServiceAsync {
    ...
    /** Get File Store Info */
    fun getFilestoresInfo(): CompletableFuture<AdminGetFilestoresInfoResponse> =
    ...
    /** Get License Info */
    fun getLicenseInfo(): CompletableFuture<AdminGetLicenseInfoResponse> =
    ...
    fun getLlamaextractFeatures(): CompletableFuture<AdminGetLlamaextractFeaturesResponse> =
    ...
    /** Get Llm Info */
    fun getLlmsInfo(): CompletableFuture<AdminGetLlmsInfoResponse> =
    ...
    fun getLlmsInfo(
        params: AdminGetLlmsInfoParams = AdminGetLlmsInfoParams.none()
    ): CompletableFuture<AdminGetLlmsInfoResponse> = getLlmsInfo(params, RequestOptions.none())
    ...
    fun getOcrStatus(): CompletableFuture<AdminGetOcrStatusResponse> =
    ...
    fun getOcrStatus(
        params: AdminGetOcrStatusParams = AdminGetOcrStatusParams.none()
    ): CompletableFuture<AdminGetOcrStatusResponse> = getOcrStatus(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * same as [AdminServiceAsync.getFilestoresInfo].
         */
        fun getFilestoresInfo():
         ...
         * same as [AdminServiceAsync.getLicenseInfo].
         */
        fun getLicenseInfo(): CompletableFuture<HttpResponseFor<AdminGetLicenseInfoResponse>> =
            getLicenseInfo(AdminGetLicenseInfoParams.none())
         ...
         * otherwise the same as [AdminServiceAsync.getLlamaextractFeatures].
         */
        fun getLlamaextractFeatures():
         ...
         * as [AdminServiceAsync.getLlmsInfo].
         */
        fun getLlmsInfo(): CompletableFuture<HttpResponseFor<AdminGetLlmsInfoResponse>> =
            getLlmsInfo(AdminGetLlmsInfoParams.none())
        ...
        fun getLlmsInfo(
            ...
            getLlmsInfo(params, RequestOptions.none())
         ...
         * same as [AdminServiceAsync.getOcrStatus].
         */
        fun getOcrStatus(): CompletableFuture<HttpResponseFor<AdminGetOcrStatusResponse>> =
            getOcrStatus(AdminGetOcrStatusParams.none())
        ...
        fun getOcrStatus(
            ...
            getOcrStatus(params, RequestOptions.none())
