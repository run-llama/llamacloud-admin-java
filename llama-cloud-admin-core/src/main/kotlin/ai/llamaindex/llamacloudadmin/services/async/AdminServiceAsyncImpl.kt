...
class AdminServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : AdminServiceAsync {

    private val withRawResponse: AdminServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val users: UserServiceAsync by lazy { UserServiceAsyncImpl(clientOptions) }

    private val usageMetrics: UsageMetricServiceAsync by lazy { UsageMetricServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): AdminServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AdminServiceAsync = AdminServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun users(): UserServiceAsync = users

    override fun usageMetrics(): UsageMetricServiceAsync = usageMetrics

    override fun getFilestoresInfo(params: AdminGetFilestoresInfoParams, requestOptions: RequestOptions): CompletableFuture<AdminGetFilestoresInfoResponse> =
        // get /api/v1/admin/filestores/info
        withRawResponse().getFilestoresInfo(params, requestOptions).thenApply { it.parse() }

    override fun getLicenseInfo(params: AdminGetLicenseInfoParams, requestOptions: RequestOptions): CompletableFuture<AdminGetLicenseInfoResponse> =
        // get /api/v1/admin/license/info
        withRawResponse().getLicenseInfo(params, requestOptions).thenApply { it.parse() }

    override fun getLlamaextractFeatures(params: AdminGetLlamaextractFeaturesParams, requestOptions: RequestOptions): CompletableFuture<AdminGetLlamaextractFeaturesResponse> =
        // get /api/v1/admin/llamaextract/features
        withRawResponse().getLlamaextractFeatures(params, requestOptions).thenApply { it.parse() }

    override fun getLlmsInfo(params: AdminGetLlmsInfoParams, requestOptions: RequestOptions): CompletableFuture<AdminGetLlmsInfoResponse> =
        // get /api/v1/admin/llms/info
        withRawResponse().getLlmsInfo(params, requestOptions).thenApply { it.parse() }

    override fun getOcrStatus(params: AdminGetOcrStatusParams, requestOptions: RequestOptions): CompletableFuture<AdminGetOcrStatusResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val usageMetrics: UsageMetricServiceAsync.WithRawResponse by lazy { UsageMetricServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AdminServiceAsync.WithRawResponse = AdminServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        override fun users(): UserServiceAsync.WithRawResponse = users

        override fun usageMetrics(): UsageMetricServiceAsync.WithRawResponse = usageMetrics

        private val getFilestoresInfoHandler: Handler<AdminGetFilestoresInfoResponse> = jsonHandler<AdminGetFilestoresInfoResponse>(clientOptions.jsonMapper)

        override fun getFilestoresInfo(params: AdminGetFilestoresInfoParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AdminGetFilestoresInfoResponse>> {
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  getFilestoresInfoHandler.handle(it)
              }
              .also {
        ...
        private val getLicenseInfoHandler: Handler<AdminGetLicenseInfoResponse> = jsonHandler<AdminGetLicenseInfoResponse>(clientOptions.jsonMapper)

        override fun getLicenseInfo(params: AdminGetLicenseInfoParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AdminGetLicenseInfoResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  getLicenseInfoHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
                    it.validate()
        ...
        private val getLlamaextractFeaturesHandler: Handler<AdminGetLlamaextractFeaturesResponse> = jsonHandler<AdminGetLlamaextractFeaturesResponse>(clientOptions.jsonMapper)

        override fun getLlamaextractFeatures(params: AdminGetLlamaextractFeaturesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AdminGetLlamaextractFeaturesResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  getLlamaextractFeaturesHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
                    it.validate()
        ...
        private val getLlmsInfoHandler: Handler<AdminGetLlmsInfoResponse> = jsonHandler<AdminGetLlmsInfoResponse>(clientOptions.jsonMapper)

        override fun getLlmsInfo(params: AdminGetLlmsInfoParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AdminGetLlmsInfoResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        private val getOcrStatusHandler: Handler<AdminGetOcrStatusResponse> = jsonHandler<AdminGetOcrStatusResponse>(clientOptions.jsonMapper)

        override fun getOcrStatus(params: AdminGetOcrStatusParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AdminGetOcrStatusResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
