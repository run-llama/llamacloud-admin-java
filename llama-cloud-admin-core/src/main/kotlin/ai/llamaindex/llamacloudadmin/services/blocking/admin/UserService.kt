...
interface UserService {
     ...
     * Global admin only.
     */
    fun getClaims(userId: String): UserClaims =
        getClaims(
          userId, UserGetClaimsParams.none()
        )

    /** @see getClaims */
    fun getClaims(userId: String, params: UserGetClaimsParams = UserGetClaimsParams.none(), requestOptions: RequestOptions = RequestOptions.none()): UserClaims =
        getClaims(
          params.toBuilder()
              .userId(userId)
    ...
    /** @see getClaims */
    fun getClaims(userId: String, params: UserGetClaimsParams = UserGetClaimsParams.none()): UserClaims =
        getClaims(
          userId,
          params,
          RequestOptions.none(),
    ...
    /** @see getClaims */
    fun getClaims(params: UserGetClaimsParams, requestOptions: RequestOptions = RequestOptions.none()): UserClaims
    ...
    /** @see updateClaims */
    fun updateClaims(userId: String, params: UserUpdateClaimsParams = UserUpdateClaimsParams.none(), requestOptions: RequestOptions = RequestOptions.none()): UserClaims =
        updateClaims(
          params.toBuilder()
              .userId(userId)
              .build(), requestOptions
    ...
    /** @see updateClaims */
    fun updateClaims(userId: String, params: UserUpdateClaimsParams = UserUpdateClaimsParams.none()): UserClaims =
        updateClaims(
          userId,
          params,
          RequestOptions.none(),
    ...
    /** @see updateClaims */
    fun updateClaims(params: UserUpdateClaimsParams, requestOptions: RequestOptions = RequestOptions.none()): UserClaims
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /api/v1/admin/users/{user_id}/claims`, but is otherwise the             same as [UserService.getClaims]. */
        @MustBeClosed
        ...
        /** @see getClaims */
        @MustBeClosed
        fun getClaims(userId: String, params: UserGetClaimsParams = UserGetClaimsParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<UserClaims> =
            getClaims(
              params.toBuilder()
                  .userId(userId)
                  .build(), requestOptions
        ...
        /** @see getClaims */
        @MustBeClosed
        fun getClaims(userId: String, params: UserGetClaimsParams = UserGetClaimsParams.none()): HttpResponseFor<UserClaims> =
            getClaims(
              userId,
              params,
              RequestOptions.none(),
        ...
        /** @see getClaims */
        @MustBeClosed
        fun getClaims(params: UserGetClaimsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<UserClaims>
        ...
        /** Returns a raw HTTP response for `patch /api/v1/admin/users/{user_id}/claims`, but is otherwise the             same as [UserService.updateClaims]. */
        @MustBeClosed
        ...
        /** @see updateClaims */
        @MustBeClosed
        fun updateClaims(userId: String, params: UserUpdateClaimsParams = UserUpdateClaimsParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<UserClaims> =
            updateClaims(
              params.toBuilder()
                  .userId(userId)
                  .build(), requestOptions
        ...
        /** @see updateClaims */
        @MustBeClosed
        fun updateClaims(userId: String, params: UserUpdateClaimsParams = UserUpdateClaimsParams.none()): HttpResponseFor<UserClaims> =
            updateClaims(
              userId,
              params,
              RequestOptions.none(),
        ...
        /** @see updateClaims */
        @MustBeClosed
        fun updateClaims(params: UserUpdateClaimsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<UserClaims>
        ...
        /** @see updateClaims */
        @MustBeClosed
        fun updateClaims(userId: String, requestOptions: RequestOptions): HttpResponseFor<UserClaims> =
            updateClaims(
              userId,
              UserUpdateClaimsParams.none(),
              requestOptions,
