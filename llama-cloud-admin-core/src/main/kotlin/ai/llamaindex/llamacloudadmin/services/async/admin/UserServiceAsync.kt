...
interface UserServiceAsync {
    ...
    fun getClaims(
        userId: String,
        params: UserGetClaimsParams = UserGetClaimsParams.none(),
    ): CompletableFuture<UserClaims> = getClaims(userId, params, RequestOptions.none())
    ...
    fun updateClaims(
        userId: String,
        params: UserUpdateClaimsParams = UserUpdateClaimsParams.none(),
    ): CompletableFuture<UserClaims> = updateClaims(userId, params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [UserServiceAsync.getClaims].
         */
        ...
        fun getClaims(
            ...
            params: UserGetClaimsParams = UserGetClaimsParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<UserClaims>> =
            getClaims(params.toBuilder().userId(userId).build(), requestOptions)
        ...
        fun getClaims(
            ...
            getClaims(userId, params, RequestOptions.none())
         ...
         * otherwise the same as [UserServiceAsync.updateClaims].
         */
        ...
        fun updateClaims(
            ...
            updateClaims(userId, params, RequestOptions.none())
