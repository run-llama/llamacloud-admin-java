...
interface ProjectService {
    ...
    /** @see update */
    fun update(projectId: String, params: ProjectUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): Project =
        update(
          params.toBuilder()
              .projectId(projectId)
    ...
    /** @see delete */
    fun delete(projectId: String, params: ProjectDeleteParams = ProjectDeleteParams.none(), requestOptions: RequestOptions = RequestOptions.none()) =
        delete(
          params.toBuilder()
              .projectId(projectId)
              .build(), requestOptions
    ...
    /** @see delete */
    fun delete(params: ProjectDeleteParams) =
        delete(
          params, RequestOptions.none()
        )
    ...
    /** @see get */
    fun get(projectId: String, params: ProjectGetParams = ProjectGetParams.none(), requestOptions: RequestOptions = RequestOptions.none()): Project =
        get(
          params.toBuilder()
              .projectId(projectId)
              .build(), requestOptions
    ...
    /** @see get */
    fun get(params: ProjectGetParams, requestOptions: RequestOptions = RequestOptions.none()): Project

    /** @see get */
    fun get(params: ProjectGetParams): Project =
        get(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /api/v2/projects`, but is otherwise the             same as [ProjectService.create]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `put /api/v2/projects/{project_id}`, but is otherwise the             same as [ProjectService.update]. */
        @MustBeClosed
        ...
        /** @see update */
        @MustBeClosed
        fun update(projectId: String, params: ProjectUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Project> =
            update(
              params.toBuilder()
                  .projectId(projectId)
                  .build(), requestOptions
        ...
        /** Returns a raw HTTP response for `get /api/v2/projects`, but is otherwise the             same as [ProjectService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `delete /api/v2/projects/{project_id}`, but is otherwise the             same as [ProjectService.delete]. */
        @MustBeClosed
        fun delete(projectId: String): HttpResponse =
            delete(
              projectId, ProjectDeleteParams.none()
            )
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(projectId: String, params: ProjectDeleteParams = ProjectDeleteParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponse =
            delete(
              params.toBuilder()
                  .projectId(projectId)
                  .build(), requestOptions
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(projectId: String, params: ProjectDeleteParams = ProjectDeleteParams.none()): HttpResponse =
            delete(
              projectId,
              params,
              RequestOptions.none(),
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(params: ProjectDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
        ...
        /** Returns a raw HTTP response for `get /api/v2/projects/{project_id}`, but is otherwise the             same as [ProjectService.get]. */
        @MustBeClosed
        ...
        /** @see get */
        @MustBeClosed
        fun get(projectId: String, params: ProjectGetParams = ProjectGetParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Project> =
            get(
              params.toBuilder()
                  .projectId(projectId)
                  .build(), requestOptions
        ...
        /** @see get */
        @MustBeClosed
        fun get(projectId: String, params: ProjectGetParams = ProjectGetParams.none()): HttpResponseFor<Project> =
            get(
              projectId,
              params,
              RequestOptions.none(),
        ...
        /** @see get */
        @MustBeClosed
        fun get(params: ProjectGetParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Project>
