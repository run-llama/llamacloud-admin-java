...
class AdminServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : AdminService {

    private val withRawResponse: AdminService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AdminService = AdminServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun users(): UserService = users

    override fun usageMetrics(): UsageMetricService = usageMetrics

    override fun getFilestoresInfo(params: AdminGetFilestoresInfoParams, requestOptions: RequestOptions): AdminGetFilestoresInfoResponse =
        // get /api/v1/admin/filestores/info
        withRawResponse().getFilestoresInfo(params, requestOptions).parse()

    override fun getLicenseInfo(params: AdminGetLicenseInfoParams, requestOptions: RequestOptions): AdminGetLicenseInfoResponse =
        // get /api/v1/admin/license/info
        withRawResponse().getLicenseInfo(params, requestOptions).parse()

    override fun getLlamaextractFeatures(params: AdminGetLlamaextractFeaturesParams, requestOptions: RequestOptions): AdminGetLlamaextractFeaturesResponse =
        // get /api/v1/admin/llamaextract/features
        withRawResponse().getLlamaextractFeatures(params, requestOptions).parse()

    override fun getLlmsInfo(params: AdminGetLlmsInfoParams, requestOptions: RequestOptions): AdminGetLlmsInfoResponse =
        // get /api/v1/admin/llms/info
        withRawResponse().getLlmsInfo(params, requestOptions).parse()

    override fun getOcrStatus(params: AdminGetOcrStatusParams, requestOptions: RequestOptions): AdminGetOcrStatusResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val usageMetrics: UsageMetricService.WithRawResponse by lazy { UsageMetricServiceImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AdminService.WithRawResponse = AdminServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun getFilestoresInfo(params: AdminGetFilestoresInfoParams, requestOptions: RequestOptions): HttpResponseFor<AdminGetFilestoresInfoResponse> {
        ...
        override fun getLicenseInfo(params: AdminGetLicenseInfoParams, requestOptions: RequestOptions): HttpResponseFor<AdminGetLicenseInfoResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun getLlamaextractFeatures(params: AdminGetLlamaextractFeaturesParams, requestOptions: RequestOptions): HttpResponseFor<AdminGetLlamaextractFeaturesResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun getLlmsInfo(params: AdminGetLlmsInfoParams, requestOptions: RequestOptions): HttpResponseFor<AdminGetLlmsInfoResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun getOcrStatus(params: AdminGetOcrStatusParams, requestOptions: RequestOptions): HttpResponseFor<AdminGetOcrStatusResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
