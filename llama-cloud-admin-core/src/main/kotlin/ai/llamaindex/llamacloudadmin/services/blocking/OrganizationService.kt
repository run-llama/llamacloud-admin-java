...
interface OrganizationService {
    ...
    /** @see create */
    fun create(params: OrganizationCreateParams, requestOptions: RequestOptions = RequestOptions.none()): Organization
    ...
    /** @see update */
    fun update(organizationId: String, params: OrganizationUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): Organization =
        update(
          params.toBuilder()
    ...
    /** @see delete */
    fun delete(organizationId: String, params: OrganizationDeleteParams = OrganizationDeleteParams.none(), requestOptions: RequestOptions = RequestOptions.none()) =
        delete(
          params.toBuilder()
              .organizationId(organizationId)
              .build(), requestOptions
    ...
    /** @see delete */
    fun delete(organizationId: String, params: OrganizationDeleteParams = OrganizationDeleteParams.none()) =
        delete(
          organizationId,
          params,
          RequestOptions.none(),
    ...
    /** @see get */
    fun get(organizationId: String, params: OrganizationGetParams = OrganizationGetParams.none(), requestOptions: RequestOptions = RequestOptions.none()): Organization =
        get(
          params.toBuilder()
              .organizationId(organizationId)
              .build(), requestOptions
    ...
    /** @see get */
    fun get(organizationId: String, params: OrganizationGetParams = OrganizationGetParams.none()): Organization =
        get(
          organizationId,
          params,
          RequestOptions.none(),
    ...
    /** @see get */
    fun get(params: OrganizationGetParams, requestOptions: RequestOptions = RequestOptions.none()): Organization

    /** @see get */
    fun get(params: OrganizationGetParams): Organization =
        get(
          params, RequestOptions.none()
        )
    ...
    /** @see getUsage */
    fun getUsage(organizationId: String, params: OrganizationGetUsageParams = OrganizationGetUsageParams.none(), requestOptions: RequestOptions = RequestOptions.none()): UsageAndPlan =
        getUsage(
          params.toBuilder()
              .organizationId(organizationId)
              .build(), requestOptions
    ...
    /** @see getUsage */
    fun getUsage(organizationId: String, params: OrganizationGetUsageParams = OrganizationGetUsageParams.none()): UsageAndPlan =
        getUsage(
          organizationId,
          params,
          RequestOptions.none(),
    ...
    /** @see getUsage */
    fun getUsage(params: OrganizationGetUsageParams, requestOptions: RequestOptions = RequestOptions.none()): UsageAndPlan
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /api/v2/organizations`, but is otherwise the             same as [OrganizationService.create]. */
        @MustBeClosed
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: OrganizationCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Organization>

        /** Returns a raw HTTP response for `put /api/v2/organizations/{organization_id}`, but is otherwise the             same as [OrganizationService.update]. */
        @MustBeClosed
        fun update(organizationId: String, params: OrganizationUpdateParams): HttpResponseFor<Organization> =
            update(
              organizationId,
              params,
              RequestOptions.none(),
        ...
        /** @see update */
        @MustBeClosed
        fun update(organizationId: String, params: OrganizationUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Organization> =
            update(
              params.toBuilder()
                  .organizationId(organizationId)
                  .build(), requestOptions
        ...
        /** Returns a raw HTTP response for `get /api/v2/organizations`, but is otherwise the             same as [OrganizationService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `delete /api/v2/organizations/{organization_id}`, but is otherwise the             same as [OrganizationService.delete]. */
        @MustBeClosed
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(organizationId: String, params: OrganizationDeleteParams = OrganizationDeleteParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponse =
            delete(
              params.toBuilder()
                  .organizationId(organizationId)
                  .build(), requestOptions
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(organizationId: String, params: OrganizationDeleteParams = OrganizationDeleteParams.none()): HttpResponse =
            delete(
              organizationId,
              params,
              RequestOptions.none(),
        ...
        /** Returns a raw HTTP response for `get /api/v2/organizations/{organization_id}`, but is otherwise the             same as [OrganizationService.get]. */
        @MustBeClosed
        ...
        /** @see get */
        @MustBeClosed
        fun get(organizationId: String, params: OrganizationGetParams = OrganizationGetParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Organization> =
            get(
              params.toBuilder()
                  .organizationId(organizationId)
                  .build(), requestOptions
        ...
        /** @see get */
        @MustBeClosed
        fun get(organizationId: String, params: OrganizationGetParams = OrganizationGetParams.none()): HttpResponseFor<Organization> =
            get(
              organizationId,
              params,
              RequestOptions.none(),
        ...
        /** @see get */
        @MustBeClosed
        fun get(params: OrganizationGetParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Organization>
        ...
        /** @see get */
        @MustBeClosed
        fun get(organizationId: String, requestOptions: RequestOptions): HttpResponseFor<Organization> =
            get(
              organizationId,
              OrganizationGetParams.none(),
              requestOptions,
        ...
        /** Returns a raw HTTP response for `get /api/v1/organizations/{organization_id}/usage`, but is otherwise the             same as [OrganizationService.getUsage]. */
        @MustBeClosed
        ...
        /** @see getUsage */
        @MustBeClosed
        fun getUsage(organizationId: String, params: OrganizationGetUsageParams = OrganizationGetUsageParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<UsageAndPlan> =
            getUsage(
              params.toBuilder()
                  .organizationId(organizationId)
                  .build(), requestOptions
        ...
        /** @see getUsage */
        @MustBeClosed
        fun getUsage(organizationId: String, params: OrganizationGetUsageParams = OrganizationGetUsageParams.none()): HttpResponseFor<UsageAndPlan> =
            getUsage(
              organizationId,
              params,
              RequestOptions.none(),
        ...
        /** @see getUsage */
        @MustBeClosed
        fun getUsage(params: OrganizationGetUsageParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<UsageAndPlan>
        ...
        /** @see getUsage */
        @MustBeClosed
        fun getUsage(organizationId: String, requestOptions: RequestOptions): HttpResponseFor<UsageAndPlan> =
            getUsage(
              organizationId,
              OrganizationGetUsageParams.none(),
              requestOptions,
