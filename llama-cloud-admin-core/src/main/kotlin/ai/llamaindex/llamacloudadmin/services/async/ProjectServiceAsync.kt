...
interface ProjectServiceAsync {
    ...
    /** @see update */
    fun update(projectId: String, params: ProjectUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Project> =
        update(
          params.toBuilder()
              .projectId(projectId)
    ...
    fun list(requestOptions: RequestOptions): CompletableFuture<ProjectListPageAsync> =
        list(
          ProjectListParams.none(), requestOptions
        )

    /** Delete a project by ID. */
    fun delete(projectId: String): CompletableFuture<Void?> =
        delete(
          projectId, ProjectDeleteParams.none()
        )

    /** @see delete */
    fun delete(projectId: String, params: ProjectDeleteParams = ProjectDeleteParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?> =
        delete(
          params.toBuilder()
              .projectId(projectId)
              .build(), requestOptions
    ...
    /** @see delete */
    fun delete(projectId: String, params: ProjectDeleteParams = ProjectDeleteParams.none()): CompletableFuture<Void?> =
        delete(
          projectId,
          params,
          RequestOptions.none(),
    ...
    /** @see delete */
    fun delete(params: ProjectDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    fun delete(projectId: String, requestOptions: RequestOptions): CompletableFuture<Void?> =
        delete(
          projectId,
          ProjectDeleteParams.none(),
          requestOptions,
        )

    /** Get a project by ID. */
    fun get(projectId: String): CompletableFuture<Project> =
        get(
          projectId, ProjectGetParams.none()
        )

    /** @see get */
    fun get(projectId: String, params: ProjectGetParams = ProjectGetParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Project> =
        get(
          params.toBuilder()
              .projectId(projectId)
              .build(), requestOptions
    ...
    /** @see get */
    fun get(projectId: String, params: ProjectGetParams = ProjectGetParams.none()): CompletableFuture<Project> =
        get(
          projectId,
          params,
          RequestOptions.none(),
    ...
    /** @see get */
    fun get(params: ProjectGetParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Project>
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): ProjectServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `post /api/v2/projects`, but is otherwise the             same as [ProjectServiceAsync.create]. */
        ...
        /** Returns a raw HTTP response for `put /api/v2/projects/{project_id}`, but is otherwise the             same as [ProjectServiceAsync.update]. */
        fun update(projectId: String, params: ProjectUpdateParams): CompletableFuture<HttpResponseFor<Project>> =
            update(
              projectId,
              params,
              RequestOptions.none(),
        ...
        /** @see update */
        fun update(projectId: String, params: ProjectUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Project>> =
            update(
              params.toBuilder()
                  .projectId(projectId)
                  .build(), requestOptions
        ...
        /** Returns a raw HTTP response for `get /api/v2/projects`, but is otherwise the             same as [ProjectServiceAsync.list]. */
        ...
        /** @see list */
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ProjectListPageAsync>> =
            list(
              ProjectListParams.none(), requestOptions
            )

        /** Returns a raw HTTP response for `delete /api/v2/projects/{project_id}`, but is otherwise the             same as [ProjectServiceAsync.delete]. */
        ...
        /** @see delete */
        fun delete(projectId: String, params: ProjectDeleteParams = ProjectDeleteParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse> =
            delete(
              params.toBuilder()
                  .projectId(projectId)
                  .build(), requestOptions
        ...
        /** @see delete */
        fun delete(projectId: String, params: ProjectDeleteParams = ProjectDeleteParams.none()): CompletableFuture<HttpResponse> =
            delete(
              projectId,
              params,
              RequestOptions.none(),
        ...
        /** @see delete */
        fun delete(params: ProjectDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
        ...
        /** @see delete */
        fun delete(projectId: String, requestOptions: RequestOptions): CompletableFuture<HttpResponse> =
            delete(
              projectId,
              ProjectDeleteParams.none(),
              requestOptions,
        ...
        /** Returns a raw HTTP response for `get /api/v2/projects/{project_id}`, but is otherwise the             same as [ProjectServiceAsync.get]. */
        ...
        /** @see get */
        fun get(projectId: String, params: ProjectGetParams = ProjectGetParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Project>> =
            get(
              params.toBuilder()
                  .projectId(projectId)
                  .build(), requestOptions
        ...
        /** @see get */
        fun get(projectId: String, params: ProjectGetParams = ProjectGetParams.none()): CompletableFuture<HttpResponseFor<Project>> =
            get(
              projectId,
              params,
              RequestOptions.none(),
        ...
        /** @see get */
        fun get(params: ProjectGetParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Project>>
        ...
        /** @see get */
        fun get(projectId: String, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Project>> =
            get(
              projectId,
              ProjectGetParams.none(),
              requestOptions,
