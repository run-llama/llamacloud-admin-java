...
class OrganizationServiceImpl internal constructor(
    ...
    override fun create(params: OrganizationCreateParams, requestOptions: RequestOptions): Organization =
        // post /api/v2/organizations
        withRawResponse().create(params, requestOptions).parse()

    override fun update(params: OrganizationUpdateParams, requestOptions: RequestOptions): Organization =
    ...
    override fun getUsage(params: OrganizationGetUsageParams, requestOptions: RequestOptions): UsageAndPlan =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val roles: RoleService.WithRawResponse by lazy { RoleServiceImpl.WithRawResponseImpl(clientOptions) }
        ...
        override fun create(params: OrganizationCreateParams, requestOptions: RequestOptions): HttpResponseFor<Organization> {
        ...
        override fun update(params: OrganizationUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Organization> {
        ...
        override fun get(params: OrganizationGetParams, requestOptions: RequestOptions): HttpResponseFor<Organization> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("organizationId", params.organizationId().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun getUsage(params: OrganizationGetUsageParams, requestOptions: RequestOptions): HttpResponseFor<UsageAndPlan> {
          // We check here instead of in the params builder because this can be specified positionally or in the params class.
          checkRequired("organizationId", params.organizationId().getOrNull())
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
